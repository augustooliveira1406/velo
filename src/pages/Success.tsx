...
const Success = () => {
  ...
  const isAnalysis = order.status === 'EM_ANALISE';
        ...
        <div className="text-center mb-8">
          <h1
            ...
            className={cn(
              ...
              isApproved ? 'text-success' : isAnalysis ? 'text-warning' : 'text-destructive'
            )}
          >
            {isApproved ? 'Pedido Aprovado!' : isAnalysis ? 'Pedido em Análise!' : 'Crédito Reprovado'}
          </h1>
          <p className="text-muted-foreground">
            {isApproved
              ? 'Seu pedido foi processado com sucesso. Em breve entraremos em contato.'
              : isAnalysis
              ? 'Seu pedido está em análise de crédito. Você receberá uma resposta em breve.'
